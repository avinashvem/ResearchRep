...
\begin{figure*}[ht]
		\begin{tabular}{cc}
			\subfloat[$M=10^5(\mu=0.41), \tilde{N}=10^7, ~G=10^{5}$]{\resizebox{0.35\textwidth}{!}{\input{Figures/sim_results_M_10_7.tex}}}&
			\subfloat[$M=10^3(\mu=0.25),~ \tilde{N}=10^6, ~G=10^{6}$]{\resizebox{0.35\textwidth}{!}{\input{Figures/sim_results_M_10_3.tex}}}
		\end{tabular}
