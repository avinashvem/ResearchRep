...
\begin{itemize}\itemsep5pt
	...
	\item {\color{blue} Signal Model:} When $\yv$ does not match with $\xv$, $\xv$ and $\yv$ are uncorrelated
\end{itemize}
\end{block}
...
%	\end{frame}	
	...
	\only<1-3>{\begin{block}{Example 1}
        ...
        \vspace{-7pt}
				\begin{figure}[t]	\includegraphics[width=2.6in]{Factorgraph_example1_tilde}
				\end{figure}}
...
\begin{block}{Error Events}
		\begin{itemize}\small
				...
				\item {\color{blue}$\mathcal{E}_2${-\it Pos. Identification}}: Position of singleton is identified wrongly, given a singleton
                    \begin{itemize}
                      \item Bounds from the compressed sensing literature
                    \end{itemize}
                    \pause
