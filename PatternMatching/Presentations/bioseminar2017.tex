...
\begin{frame}\frametitle{Notation}
	...
	\end{frame}	
% ----------------------------------------Notations---------------------------------------
\begin{frame}\frametitle{What do profs do on friday evenings?}
\begin{columns}
	\column{0.65\columnwidth}
\vspace*{-0.2in}
\begin{figure}
  \centering
  \includegraphics[width=3.0in]{eccell}
  \end{figure}
  \pause
  	\column{0.35\columnwidth}
\begin{figure}
  \centering
  \includegraphics[width=1.0in]{shazamimage}
\end{figure}
Talk about shazam!
\end{columns}
\end{frame}
...
\begin{figure}
  \centering
  \includegraphics[width=2.0in]{../Figures/Gaspard_de_Prony}
\end{figure}
\end{frame}
%--------------------------------------------------------------------------------------
\begin{frame}{Spectral Estimation}
...
\end{frame}
	...
	\begin{figure}[t]
		\centering
		\includegraphics[width=3.6in]{C:/Users/nrkri/Dropbox/Work/RESEARCH/Presentations/NASIT2016/Figures/FFAST_2stages_example6}
	\end{figure}
	\vspace*{-4mm}
	\begin{figure}[t]
		\includegraphics[width=2.9in]{C:/Users/nrkri/Dropbox/Work/RESEARCH/Presentations/NASIT2016/Figures/Factorgraph_example_tilde}
	\end{figure}
...
\resizebox{3.0in}{!}
{
\input{C:/Users/nrkri/Dropbox/Work/RESEARCH/Presentations/NASIT2016/Figures/Factorgraph_example_tilde.tex}
}
			\end{figure}
	...
	\only<1-3>{\begin{block}{Example 1}
		...
		\begin{columns}
			\only<2-3>{
                ...
                \resizebox{2.0in}{!}
                {
                \input{C:/Users/nrkri/Dropbox/Work/RESEARCH/Presentations/NASIT2016/Figures/Factorgraph_example_tilde_abbrv.tex}
                }

				\column{0.55\textwidth}
        \vspace{-7pt}
				\begin{figure}[t]	\includegraphics[width=2.6in]{C:/Users/nrkri/Dropbox/Work/RESEARCH/Presentations/NASIT2016/Figures/Factorgraph_example1_tilde}
				\end{figure}}
