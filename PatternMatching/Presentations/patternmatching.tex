...
\begin{frame} \frametitle{Some Prior Work}
	...
	\begin{block}{\alert{Approximate Matching}}
	 	...
	 	\begin{itemize}
	 		...
	 		\item {\color{blue} \bf Andoni'13}: $O\left(N^{1-0.359\mu}\right)$ (sub-linear even when $K = O(M)$)
	 		\begin{itemize}
...
\begin{frame}{Spectral Estimation}
	...
	\only<1>{\begin{columns}
		...
		\begin{figure}
			\centering
			\scalebox{0.70}{\input{monotone_time.tex}}
		\end{figure}
		
		\column{0.45\textwidth}
		\begin{figure}
			\centering
			\scalebox{0.70}{\input{monotone_freq.tex}}
		\end{figure}
...
\only<2>{\begin{columns}
		...
		\begin{figure}
			\centering
			\scalebox{0.70}{\input{multitone_time.tex}}
		\end{figure}
		
		\column{0.45\textwidth}	
		\begin{figure}
			\centering
			\scalebox{0.70}{\input{multitone_freq.tex}}
		\end{figure}
\end{columns}
}	
\end{frame}
