...
\begin{figure}
\centering
\resizebox{\fract\columnwidth}{!}{\input{\fig_path/database_x.tex}}
\caption{Database: $x[n]$}
\end{figure}
...
\begin{column}{0.48\textwidth}
Fourier Domain ($N$-pt FFT)
\begin{figure}
\centering
\resizebox{0.7\columnwidth}{!}{\input{\fig_path/query_y.tex}}
\end{figure}

\begin{figure}
\centering
\resizebox{0.7\columnwidth}{!}{\input{\fig_path/database_x.tex}}
\end{figure}
