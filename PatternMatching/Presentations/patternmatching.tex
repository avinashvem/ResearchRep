...
\begin{figure}
\centering
\text{$x[n]:$}\resizebox{\fractx\columnwidth}{\fracty\columnwidth}{\input{\fig_path/database_x.tex}}
%\caption{\small{Database: $x[n]$}}
\end{figure}
\vspace{-0.2in}

\begin{figure}
\centering
\text{$y[n]:$}\resizebox{\fractx\columnwidth}{\fracty\columnwidth}{\input{\fig_path/query_y.tex}}
\end{figure}
...
\begin{figure}
\centering
\text{corr $r[n]$}\resizebox{\fractx\columnwidth}{\fracty\columnwidth}{\input{\fig_path/corr_est.tex}}
\end{figure}
\end{column}
...
\begin{figure}[t!]
	\begin{center}
		\resizebox{1.05\textwidth}{!}{\input{FFAST_Robust_PM.tex}}
		%	 		\includegraphics[height=7cm]{Figures/FFAST_Robust} 
		\end{center}	   
		\label{fig:rsidft}
		\vspace{5 pt}
...
\begin{frame}\frametitle{RSIDFT-Decoding (Peeling Decoder)}
		...
		\begin{figure}[h!]
			\begin{center}
				%		\includegraphics[height=7cm]{Figures/Factorgraph} 
				\resizebox{0.55\textwidth}{!}{\input{Factorgraph_PM.tex}}	
			\end{center}	   
			%\caption{Example of a Tanner graph formed in a RSIDFT framework with system parameters being $d=2$, $B=2$, $N=6$, $f_1 = 2$ and $f_2=3$. The variable nodes (colored gray circles) represent the cross-correlation vector $\rv$ and the bin nodes (uncolored white boxes) represent the binned observation vector $\zv_{i,k}$. The figure also illustrates the relationship between $\zv_{i,k}$ and $\rv$.}\label{fig:factorgraph}
		\end{figure}
