...
\node at (1.5,2.5) {$\bf R[0]$};
\node at (2.5,2.5) {$\bf R[1]$};
\node at (3.5,2.5) {$\bf R[2]$};
\node at (4.5,2.5) {$\bf R[3]$};
\node at (5.5,2.5) {$\bf R[4]$};
\node at (6.5,2.5) {$\bf R[5]$};
...
\node at (10.5,2.5) {$\bf r[0]$};
\node at (11.5,2.5) {$\bf r[1]$};
\node at (12.5,2.5) {$\bf r[2]$};
\node at (13.5,2.5) {$\bf r[3]$};
\node at (14.5,2.5) {$\bf r[4]$};
\node at (15.5,2.5) {$\bf r[5]$};
\end{tikzpicture}