%& C:\Users\TJNAGA~1\AppData\Roaming\TikzEdt\TikzEdt\021~1.0\TEMP_H~1
\begin{document}
...
% Variable nodes 
\draw [thick,fill=gray,opacity=0.7,line width =2]   (-7,-6) node (v6) {} ellipse (1 and 1);
...
\node [anchor=west] at (4.6,4.2) {\Huge $ \underline{r}^{b}_{1,1} = \begin{bmatrix}
	 r^{s}_{1,1}[1] = r[0] w_1^{0} + r[3] w_1^{3}  \\
	 r^{s}_{1,2}[1] = r[0] w_2^{0} + r[3] w_2^{3} \\
	 \end{bmatrix}$};

\node [anchor=west] at (4.6,1) {\Huge $  \underline{r}^{b}_{1,2} = \begin{bmatrix}
	 r^{s}_{1,1}[2] = r[1] w_1^{1} + r[4] w_1^{4}\\
	 r^{s}_{1,2}[2] = r[1] w_2^{1} + r[4] w_2^{4}\\
	 \end{bmatrix}$};

\node [anchor=west] at (4.6,-2) {\Huge $  \underline{r}^{b}_{1,3} = \begin{bmatrix}
	 r^{s}_{1,1}[3] = r[2] w_1^{2} + r[5] w_1^{5} \\
	 r^{s}_{1,2}[3] = r[2] w_2^{2} + r[5] w_2^{5} \\
	 \end{bmatrix}$};

\node [anchor=west] at (4.6,-7.6) {\Huge $  \underline{r}^{b}_{2,1} = \begin{bmatrix}
	 r^{s}_{2,1}[1]= r[0] w_1^{0} + r[2] w_1^{2} + r[4] w_1^{4} \\
	 r^{s}_{2,2}[1] = r[0] w_2^{0} + r[2] w_2^{2} + r[4] w_2^{4}\\
	 \end{bmatrix}$};

\node [anchor=west] at (4.6,-11.1){\Huge $  \underline{r}^{b}_{2,2} = \begin{bmatrix}
	 r^{s}_{2,1}[2] =  r[1] w_1^{1} + r[3] w_1^{3} + r[5] w_1^{5} \\
	 r^{s}_{2,2}[2] =  r[1] w_2^{1} + r[3] w_2^{3} + r[5] w_2^{5} \\
	 \end{bmatrix}$};
...
\node at (11.7,7.2) {\huge $  w_i^k := \left (e^{j \frac{2 \pi s_i}{N}} \right ) ^{k}$};
