...
\node [anchor=west] at (2.9,3) {\Huge $\bf \tilde{x}_{s}[0] = r[0] w^{0}+r[3] w^{3}$};
\node [anchor=west] at (2.9,1) {\Huge $\bf x_{s}[1] = r[1]+r[4]$};
\node [anchor=west] at (2.9,-0.2) {\Huge $\bf \tilde{x}_{s}[1] = r[1] w^{1}+r[4] w^{4}$};
\node [anchor=west] at (2.9,-2) {\Huge $\bf x_{s}[2] = r[2]+r[5]$};
\node [anchor=west] at (2.9,-3.3) {\Huge $\bf \tilde{x}_{s}[2] = r[2] w^{2}+r[5] w^{5}$};

\node [anchor=west] at (2.9,-7.6) {\Huge $\bf z_{s}[0] = r[0]+r[2]+r[4]$};
\node [anchor=west] at (2.9,-8.9) {\Huge $\bf \tilde{z}_{s}[0] = r[0] w^{0}+r[2] w^{2}+r[4] w^{4}$};
\node [anchor=west] at (2.9,-11.1) {\Huge $\bf z_{s}[1] = r[1]+r[3]+r[5]$};
\node [anchor=west] at (2.9,-12.5) {\Huge $\bf \tilde{z}_{s}[1] = r[1] w^{1}+r[3] w^{3}+r[5] w^{5}$};
...
\node at (4.3,6.1) {\color{blue} \Huge$\bf w=e^{-j \frac{2\pi}{6} }$};
\end{tikzpicture}
