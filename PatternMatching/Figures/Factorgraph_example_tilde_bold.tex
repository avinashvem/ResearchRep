...
\node at (-9.6,4.8) {\Huge $\bf r[0]$};
\node at (-9.6,1.4) {\Huge $\bf r[1]$};
\node at (-9.6,-2.2) {\Huge $\bf r[2]$};
\node at (-9.6,-6) {\Huge $\bf r[3]$};
\node at (-9.6,-9.2) {\Huge $\bf r[4]$};
\node at (-9.6,-12.6) {\Huge $\bf r[5]$};
...
\node [anchor=west] at (2.9,4.2) {\Huge $\bf x_{s}[0] = r[0]+r[3]$};
\node [anchor=west] at (2.9,3) {\Huge $\bf \tilde{x}_{s}[0] = r[0] \omega^{0}+r[3] \omega^{3}$};
\node [anchor=west] at (2.9,1) {\Huge $\bf x_{s}[1] = r[1]+r[4]$};
\node [anchor=west] at (2.9,-0.2) {\Huge $\bf \tilde{x}_{s}[1] = r[1] \omega^{1}+r[4] \omega^{4}$};
\node [anchor=west] at (2.9,-2) {\Huge $\bf x_{s}[2] = r[2]+r[5]$};
\node [anchor=west] at (2.9,-3.3) {\Huge $\bf \tilde{x}_{s}[2] = r[2] \omega^{2}+r[5] \omega^{5}$};

\node [anchor=west] at (2.9,-7.6) {\Huge $\bf z_{s}[0] = r[0]+r[2]+r[4]$};
\node [anchor=west] at (2.9,-8.9) {\Huge $\bf \tilde{z}_{s}[0] = r[0] \omega^{0}+r[2] \omega^{2}+r[4] \omega^{4}$};
\node [anchor=west] at (2.9,-11.1) {\Huge $\bf z_{s}[1] = r[1]+r[3]+r[5]$};
\node [anchor=west] at (2.9,-12.5) {\Huge $\bf \tilde{z}_{s}[1] = r[1] \omega^{1}+r[3] \omega^{3}+r[5] \omega^{5}$};
...
\node at (4.3,6.1) {\color{blue} \Huge$\bf \omega=e^{j \frac{2\pi}{6} }$};
\end{tikzpicture}
