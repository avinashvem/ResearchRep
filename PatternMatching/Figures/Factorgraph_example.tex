...
\node [anchor=west] at (4.6,3.5) {\Huge $x_{s}[0] = r[0]+r[3]$};
\node [anchor=west] at (4.6,0.5) {\Huge $x_{s}[1] = r[1]+r[4]$};
\node [anchor=west] at (4.6,-2.5) {\Huge $x_{s}[2] = r[2]+r[5]$};


\node [anchor=west] at (4.6,-8.3) {\Huge $z_{s}[0] = r[0]+r[2]+r[4]$};
\node [anchor=west] at (4.6,-11.7) {\Huge $z_{s}[1] = r[1]+r[3]+r[5]$};
