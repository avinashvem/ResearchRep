...
\node [anchor=west] at (4.6,3.5) {\Huge $X_{s}[0] = X[0]+X[3]$};
\node [anchor=west] at (4.6,0.5) {\Huge $X_{s}[1] = X[1]+X[4]$};
\node [anchor=west] at (4.6,-2.5) {\Huge $X_{s}[2] = X[2]+X[5]$};


\node [anchor=west] at (4.6,-8.3) {\Huge $Z_{s}[0] = X[0]+X[2]+X[4]$};
\node [anchor=west] at (4.6,-11.7) {\Huge $Z_{s}[1] = X[1]+X[3]+X[5]$};
