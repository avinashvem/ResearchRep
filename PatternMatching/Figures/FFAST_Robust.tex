...
% paths connecting the two stages   
 ...
 \draw[thick,line  width =2pt] (-2,5.7) -- (-2,10.6);
  ...
  % DFT blocks
\node[draw,align=center,thick,line  width =2pt] at (5.8,4.5) {\Large{$\tilde{N}/f_2$ IDFT}};
\node[draw,align=center,thick,line  width =2pt] at (5.8,5.7) {\Large{$\tilde{N}/f_2$ IDFT}};
\node[draw,align=center,thick,line  width =2pt] at (5.8,2.7) {\Large{$\tilde{N}/f_2$ IDFT}};

\node[draw,align=center,thick,line  width =2pt] at (5.8,9.4) {\Large{$\tilde{N}/f_1$ IDFT}};
\node[draw,align=center,thick,line  width =2pt] at (5.8,10.6) {\Large{$\tilde{N}/f_1$ IDFT}};
\node[draw,align=center,thick,line  width =2pt] at (5.8,7.6) {\Large{$\tilde{N}/f_1$ IDFT}};
% Connectors
