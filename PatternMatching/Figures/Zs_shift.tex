...
\node (v3) at (10.8,-0.5) {$\tilde{z}_{s}[0]$};
\node (v5) at (11.8,-0.5) {$\tilde{z}_{s}[1]$};
...
\node at (15,-2.9) {$r[3] w^{3}$};
\node at (8.4,-2.9) {$\mathbf{+}$};

\node at (13.2,-2.9) {$r[1] w^{1}$};
\node at (11.1,-2.9) {$r[4] w^{4}$};
\node at (10.2,-2.9) {$\mathbf{+}$};

\node at (9.3,-2.9) {$r[2] w^{2}$};
\node at (16.8,-2.9) {$r[5] w^{5}$};
