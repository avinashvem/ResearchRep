...
\node [anchor=west] at (2.9,4.2) {\Huge $X_{s}[0] = X[0]+X[3]$};
\node [anchor=west] at (2.9,3) {\Huge $\tilde{X}_{s}[0] = X[0] w^{0}+X[3] w^{3}$};
\node [anchor=west] at (2.9,1) {\Huge $X_{s}[1] = X[1]+X[4]$};
\node [anchor=west] at (2.9,-0.2) {\Huge $\tilde{X}_{s}[1] = X[1] w^{1}+X[4] w^{4}$};
\node [anchor=west] at (2.9,-2) {\Huge $X_{s}[2] = X[2]+X[5]$};
\node [anchor=west] at (2.9,-3.3) {\Huge $\tilde{X}_{s}[2] = X[2] w^{2}+X[5] w^{5}$};

\node [anchor=west] at (2.9,-7.6) {\Huge $Z_{s}[0] = X[0]+X[2]+X[4]$};
\node [anchor=west] at (2.9,-8.9) {\Huge $\tilde{Z}_{s}[0] = X[0] w^{0}+X[2] w^{2}+X[4] w^{4}$};
\node [anchor=west] at (2.9,-11.1) {\Huge $Z_{s}[1] = X[1]+X[3]+X[5]$};
\node [anchor=west] at (2.9,-12.5) {\Huge $\tilde{Z}_{s}[1] = X[1] w^{1}+X[3] w^{3}+X[5] w^{5}$};
