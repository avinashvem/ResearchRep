...
\node [anchor=west] at (4.6,4.2) {\Huge $ \zv_{1,1} = \begin{bmatrix}
	 ...
	 \vdots\\
	 r_{1,B}[1] &=& r[0] w_B^{0} + r[3] w_B^{3} \\
	 \end{bmatrix}$};

\node [anchor=west] at (4.6,1) {\Huge $  \zv_{1,2}$};

% = \begin{bmatrix}
% r_{1,1}[2] = r[1] w_1^{1} + r[4] w_1^{4}\\
% r_{1,2}[2] = r[1] w_2^{1} + r[4] w_2^{4}\\
% \vdots\\
% r_{1,B}[2] = r[1] w_B^{1} + r[4] w_B^{4}\\
% \end{bmatrix}

\node [anchor=west] at (4.6,-2) {\Huge $  \zv_{1,3} $};

%= \begin{bmatrix}
%r_{1,1}[3] = r[2] w_1^{2} + r[5] w_1^{5} \\
%r_{1,2}[3] = r[2] w_2^{2} + r[5] w_2^{5} \\
%\vdots\\
%r_{1,B}[3] = r[2] w_B^{2} + r[5] w_B^{5} \\
%\end{bmatrix}
...
\node [anchor=west] at (4.6,-7.6) {\Huge $  \zv_{2,1} = \begin{bmatrix}
	 ...
	 \vdots\\
	 r_{2,B}[1] &=& r[0] w_B^{0} + r[2] w_B^{2} + r[4] w_B^{4}\\
	 \end{bmatrix}$};

\node [anchor=west] at (4.6,-11.1){\Huge $  \zv_{2,2} $};

%= \begin{bmatrix}
%r_{2,1}[2] =  r[1] w_1^{1} + r[3] w_1^{3} + r[5] w_1^{5} \\ \vspace{3pt}
%r_{2,2}[2] =  r[1] w_2^{1} + r[3] w_2^{3} + r[5] w_2^{5} \\
%\vdots\\
%r_{2,B}[2] =  r[1] w_B^{1} + r[3] w_B^{3} + r[5] w_B^{5} \\
%\end{bmatrix}
...
\node at (13,9) { \Huge $w_i^k := \left (  e^{j \frac{2 \pi s_i}{N}}\right )^{k}$};
\end{tikzpicture}
