...
%, is that now the left-degree of the bipartite graph, or equivalently the number of times a sample is divided for testing, cannot be finite and needs to be scaled as $\log K$.
...
\item In Eqn.~\ref{Eqn:SignatureMatrix} the parameter $p=2$ is chosen
