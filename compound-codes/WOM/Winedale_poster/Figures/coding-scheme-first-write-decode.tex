\begin{tikzpicture}
  ...
  bitnode2hidden/.style={circle, inner sep = 0pt, minimum size = 4mm, draw=white, fill=white},
    ...
    \node[white] at (5*1/3-2.5-5/3,-2.5) {\tiny $s_1$};
    \node[white] at (5*2/3-2.5-5/3,-2.5) {\tiny $s_k$};
    \node at (5*3/3-2.5-5/3,-2.5) {\tiny $0$};
    \node at (5*4/3-2.5-5/3,-2.5) {\tiny $0$};

    \draw[white,decorate,decoration={brace,amplitude=5pt,mirror}] (-2.8,-2.75) -- (-0.55,-2.75) node [midway,yshift=-0.5cm] {\tiny $\mathcal{P}_1$,  \tiny $|\mathcal{P}_1|=k$};
