\begin{tikzpicture}
  ...
  \draw[<->] (3.5,2) to [bend right=25] (4,1.5) node [right] {\tiny $d_{c}$};
  \draw[<->] (2.25,0.1) to [bend left=30] (3.5,0.5) node [right] {\tiny $d_{v}$};
  \draw[<->] (2.5,-0.1) to [bend right=30] (3.25,-0.5) node [right] {\tiny $d'_{v}$};
  \draw[<->] (2,-2) to [bend left=25] (3,-1.5) node [right] {\tiny $d'_{c}$};

  \node at (-4.5,2.5) {\tiny $n$};
  \node at (-3.8,0) {\tiny $m$};

  \node at (5*1/3-2.5-5/3,-2.5) {\tiny $s_1$};
  \node at (5*2/3-2.5-5/3,-2.5) {\tiny $s_2$};
