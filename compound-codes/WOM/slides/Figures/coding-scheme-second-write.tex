\begin{tikzpicture}
  ...
  \only<1>{
    ...
    \foreach \y in {2,3,5,8,9} {
      \node at (\y-5,4.5) {\Large{$*$}};
    }

    \foreach \y in {1,4,6,7} {
      \node at (\y-5,4.5) {\Large{$1$}};
    }
  ...
  \only<1,3>{
    ...
    \node at (-3,-4.25) {\LARGE{$\frac{n-k-k'}{n} \approx \delta$}};
    \node at (3,-4.25) {\LARGE{$\frac{n-k'}{n} \approx 1 - h(p) $}};
  }

  \only<2>{

    \foreach \y in {2,3,5,8,9} {
      \node at (\y-5,4.5) {\Large{$0$}};
    }
    ...
    \node[white] at (5*2/3-2.5-5/3,-2.5) {$s_k$};
    \node at (5*3/3-2.5-5/3,-2.5) {$0$};
    \node at (5*4/3-2.5-5/3,-2.5) {$0$};
    ...
    \node[white] at (-3,-4.25) {\LARGE{$\frac{n-k-k'}{n}\approx \delta $}};
    \node at (3,-4.25) {\LARGE{$\frac{n-k'}{n}\approx 1 - h(p)$}};
  }
