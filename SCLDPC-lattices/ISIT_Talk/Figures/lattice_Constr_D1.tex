...
\path[use as bounding box] (-3.5,3) rectangle (11,-6);
%Uncoded level
...
\draw[ultra thick] (-3,1) -- (0.25,1);  \node [above, font=\LARGE] at (-2.5,1){$\underline{w}_{L}$} ;
\draw [ultra thick](-3,-4) -- (0.25,-4); \node [above, font=\LARGE] at (-2.5,-4){$\underline{w}_{1}$} ;
...
\draw [ultra thick][->] (8,-1.5) -- (10.5,-1.5);
 \node [font=\LARGE] at (9.2,-1.2){$\lambda\in \Lambda$} ;
