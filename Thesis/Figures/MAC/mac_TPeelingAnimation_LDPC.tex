...
\onslide<1>{             
\foreach \vn in {1,...,6}{
\node[block] (vn\vn) at (0,-\vn*\gapVN) {\fsize \begin{tabular}{c}
Repeat \\
$\ell(w_1)$ times
\end{tabular}};
\node[block] (vna\vn) at (vn\vn)++(-\ext,0) {\fsize \textbf{Encoder} $\mc{C}$};
...
\draw[line width=0.05mm,densely dotted] (vn4.east)--(cn4.west);
\draw[line width=0.05mm,densely dotted] (vn3.east)--(cn4.west);

\draw[line width=0.05mm,densely dotted] (vn3.east)--(cn1.west);
...
\node [scale=0.2,anchor=west] at (cn1.east) {\tiny{$\vec{x}_5+\vec{x}_6+\vec{z}_1$}};
\node [scale=0.2,anchor=west] at (cn2.east) {\tiny{$\vec{z}_2$}};
\node [scale=0.2,anchor=west] at (cn3.east) {\tiny{$\vec{z}_3$}};
\node [scale=0.2,anchor=west] at (cn4.east) {\tiny{$\vec{z}_4$}};
}
...
\draw[line width=0.05mm,densely dotted] (vn5.east)--(cn1.west);
\draw[line width=0.05mm,densely dotted] (vn6.east)--(cn1.west);
...
\node [scale=0.2,anchor=west] at (cn1.east) {\tiny{$\vec{z}_1$}};
\node [scale=0.2,anchor=west] at (cn2.east) {\tiny{$\vec{z}_2$}};
\node [scale=0.2,anchor=west] at (cn3.east) {\tiny{$\vec{z}_3$}};
\node [scale=0.2,anchor=west] at (cn4.east) {\tiny{$\vec{z}_4$}};

\node[scale=0.35] () at (0.5*\horzgap,-5*\gapCN) {\tiny{Successfully decoded}};
}
