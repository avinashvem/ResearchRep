...
\addlegendentry{\emph{BCH}, list dec.,T=2};
...
\addlegendentry{\emph{BCH}, list dec., T=3};
...
\addlegendentry{\emph{BCH}, correlation dec.,T=2};
...
\addlegendentry{\emph{BCH}, correlation dec., T=3};
...
\addplot [color=ForestGreen,solid]%,mark=triangle,mark options={solid}]
  table[row sep=crcr]{
-4.00 0.3042\\
-3.00 0.1068\\
-2.00 0.0284\\
