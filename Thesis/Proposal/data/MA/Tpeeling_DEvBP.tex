...
xmax=0.75,
xmajorgrids,
xtick={0.25,0.30,...,0.75},
xlabel={\LARGE $\alpha=\frac{V}{\Ka}$},
ymode=log,
ymin=1e-07,
ymax=1,
yminorticks=false,
...
line width=2.5pt,
mark size=3.5pt,
legend style={at={(0.4,1)},anchor=north, draw=black,fill=white,legend cell align=left,font=\fsize}
]

\node[] at (axis cs: 0.267,5e-4) {\fsize $T=4$};
\node[] at (axis cs: 0.28,1e-6) {\fsize $\alpha^*_{\text{DE}}$};
%\node[] at (axis cs: 0.36,1e-6) {\fsize $500$};
%\node[] at (axis cs: 0.335,4e-7) {\fsize $1000$};
%\node[right] at (axis cs: 0.282,2e-7) {\fsize $3000$};


\node[] at (axis cs: 0.585,1e-6) {\fsize $\alpha^*_{\text{DE}}$};
\node[] at (axis cs: 0.575,5e-4) {\fsize $T=2$};
%\node[] at (axis cs: 0.705,2.5e-4) {\fsize $500$};
%\node[] at (axis cs: 0.695,4e-5) {\fsize $1000$};
%\node[right] at (axis cs: 0.66,5e-6) {\fsize $3000$};
\node[right] at (axis cs: 0.625,6e-7) {\fsize $\Ka=10000$};

\addplot [color=blue,solid,mark=triangle,line width=2.5pt]
  table[row sep=crcr]{
...
\addplot [color=red,solid,mark=asterisk,mark options=solid,mark size=3.0,line width=2.5pt]
  table[row sep=crcr]{
...
\addlegendentry{$\Ka=1000$};

\addplot [color=black,solid,mark=o,mark options=solid,line width=2.5pt]
  table[row sep=crcr]{
...
\addlegendentry{$\Ka=3000$};

\addplot [color=green,solid,mark=square,mark options=solid,line width=2.5pt]
  table[row sep=crcr]{
0.58	    0.2324    \\
0.60     0.1444\\
0.61	    0.0022\\
...
\addplot [color=black,dotted,line width=2.5pt]
  table[row sep=crcr]{
0.5975	5.00e-2 \\
0.5975	1.00e-2 \\
0.5975	5.00e-3 \\
...
\addplot [color=red,solid,mark=asterisk,mark options=solid,line width=2.5pt]
  table[row sep=crcr]{
0.2900    0.3920\\
0.3100    0.0039\\
0.3200    3.295189e-5\\
